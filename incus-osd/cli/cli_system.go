...
func (c *cmdAdminOSSystem) command() *cobra.Command {
	...
	type subCommand struct {
		...
		infoFunc      func(os *cmdAdminOS, endpoint string, description string) *cobra.Command
	}
	...
	subCommands := []subCommand{
		...
		},
		{
			...
			isWritable:  true,
			infoFunc:    systemInfoCommand,
		},
		{
			name:        "network",
			description: "Network configuration",
			isWritable:  true,
			infoFunc:    systemInfoNetworkCommand,
			extraCommands: func() []*cobra.Command {
		...
		},
		{
			...
			isWritable:  false,
			infoFunc:    systemInfoResourcesCommand,
		},
		{
			name:        "security",
		...
		},
		{
			...
			isWritable:  true,
			infoFunc:    systemInfoStorageCommand,
			extraCommands: func() []*cobra.Command {
	...
	for _, sub := range subCommands {
		...
		// Info.
		if sub.infoFunc != nil {
			subCmd.AddCommand(sub.infoFunc(c.os, "system/"+sub.name, "Show "+sub.description))
		}
